...
<html lang="fr">
  <head>
    ...
    <title>Réunions — Kotiz by Draken</title>
  ...
  <body data-page="reunions">
      ...
      <div class="app-main">
        <header class="topbar">
          ...
          <div class="topbar-title">
            <h1>Réunions</h1>
            <p>Créer et gérer les réunions mensuelles</p>
          </div>
          <div class="topbar-actions">
            <?php if (($_SESSION['role'] ?? null) === 'admin'): ?>
            <button class="btn btn-success" onclick="ouvrirModalCreation()"><i class="fa-solid fa-plus"></i> <span class="btn-label">Nouvelle réunion</span></button>
            <?php endif; ?>
          </div>
        </header>
        ...
        <main class="content">
          ...
          <div class="stats-grid stats-grid-page">
            <div class="stat-card">
              ...
              <h3 id="statReunionsTotal">0</h3>
              <p>Total réunions</p>
            </div>
            <div class="stat-card">
              <div class="stat-icon"><i class="fa-solid fa-circle-play"></i></div>
              <h3 id="statReunionsEnCours">0</h3>
              <p>En cours</p>
            </div>
            <div class="stat-card">
              <div class="stat-icon"><i class="fa-solid fa-circle-check"></i></div>
              <h3 id="statReunionsCloturees">0</h3>
              <p>Clôturées</p>
            </div>
          </div>
          ...
          <div class="form-group">
            <input
              ...
              id="filtreInput"
              class="form-control"
              placeholder="Rechercher par titre, date ou projet..."
              oninput="filtrerReunions()"
            />
          </div>
    ...
    <div id="modal" class="modal">
      <div class="modal-content">
        <div class="modal-header">
          <h2 id="modalTitle">Créer une réunion</h2>
        ...
        <form id="reunionForm">
          ...
          <div class="form-group">
            ...
            <input
              ...
              id="titre"
              class="form-control"
              placeholder="Ex: Réunion mensuelle de mars 2026"
            />
          </div>

          <div class="form-group">
            <label for="dateReunion">Date de la réunion *</label>
            <input type="date" id="dateReunion" class="form-control" required />
          </div>

          <div class="form-group">
            <label for="projetId">Lier à un projet en cours</label>
          ...
          <div class="alert alert-info show">
            <strong>ℹ️ Information :</strong> La création d'une réunion génère
            automatiquement la liste de présence et les cotisations.
          </div>

          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-close="modal">Annuler</button>
            <button type="submit" class="btn btn-success" id="btnSubmit">Créer la réunion</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <script src="<?= asset_url('js/reunions.js') ?>"></script>
  </body>
</html>
